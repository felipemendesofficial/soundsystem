...
import type { MovimentoAplicacaoFormState } from "@/app/(app)/aplicacoes-financeiras/actions";

type Action = (prevState: MovimentoAplicacaoFormState, formData: FormData) => Promise<MovimentoAplicacaoFormState>;

export function EstornarMovimentoAplicacaoButton({ action }: { action: Action }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Estornar movimento de aplicação?</DialogTitle>
          <DialogDescription>Cria um movimento reverso e devolve o saldo das contas envolvidas. Não tem volta.</DialogDescription>
        </DialogHeader>
