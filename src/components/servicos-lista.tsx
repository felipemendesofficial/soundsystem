            ...
            <li key={item.id}>
              ...
              >
                ...
                <div className="min-w-0">
                  <div className="truncate text-[11px] leading-tight text-muted-foreground">Preço Padrão</div>
                  <div className="truncate text-[14px] leading-tight font-medium">{item.precoPadrao}</div>
                </div>
              </Link>
            </li>
          ))}
