...
export function ExcluirLancamentoButton({ action }: { action: Action }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button type="button" variant="destructive" size="sm" className="flex-none whitespace-nowrap" />}>
        Excluir
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Excluir previsão?</DialogTitle>
          <DialogDescription>Isso apaga o lançamento e seu rateio definitivamente. Não tem volta.</DialogDescription>
        </DialogHeader>
        <DialogFooter>
