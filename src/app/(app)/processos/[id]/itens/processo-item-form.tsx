...
import type { ProcessoItemFormState } from "../../actions";

type Action = (prevState: ProcessoItemFormState, formData: FormData) => Promise<ProcessoItemFormState>;

const labelClass = "text-[15px] font-semibold";
const inputClass = "h-11 px-3.5 text-base bg-card";

export function ProcessoItemForm({
  action,
  cancelarHref,
  prefixo,
  qtdDigitos,
